    ...
    <div className="row">
      ...
      <div className="col-lg-3 col-md-6 footer-links">
        ...
        <div className="social-links mt-3">
          <a href="https://twitter.com" className="nav-link twitter"><FiTwitter/></a>
          <a href="https://www.linkedin.com" className="nav-link twitter"><AiFillLinkedin/></a>
          <a href="https://www.instagram.com" className="nav-link twitter"><FiInstagram/></a>
          <a href="https://mail.google.com/mail" className="nav-link twitter"><FiMail/></a>
        </div>
      </div>
...
<div className="container py-4">
  <div className="copyright">
    &copy; Copyright <strong><span>Auction</span></strong>. All Rights Reserved
  </div>
